...
class SleepTrackerViewModel(
    ...
    //TODO (01 Navigation) create encapsulated LiveData navigateToSleepQuality and doneNavigating() function.
    ...
    fun onStopTracking() {
        uiScope.launch {
            ...
            update(oldNight)
            _navigateToSleepQuality.value = oldNight //Add after of navigate
        }
    }
